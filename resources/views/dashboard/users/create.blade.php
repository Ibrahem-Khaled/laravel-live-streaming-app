    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="row align-items-center mb-4">
                <div class="col">
                    <h2 class="h5 page-title">إضافة مستخدم جديد</h2>
                </div>
                <div class="col-auto">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="username" id="username" class="form-control @error('username') is-invalid @enderror" value="{{ old('username') }}" placeholder="اختياري - يُولَّد تلقائياً من الاسم">
                                    <small class="form-text text-muted">اتركه فارغاً ليتم إنشاؤه تلقائياً من الاسم أو البريد</small>
