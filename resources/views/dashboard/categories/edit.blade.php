    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="row align-items-center mb-4">
                <div class="col">
                    <h2 class="h5 page-title">تعديل فئة: {{ $category->name }}</h2>
                </div>
                <div class="col-auto">
            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    <form action="{{ route('dashboard.categories.update', $category) }}" method="post" enctype="multipart/form-data">
                        ...
                        <x-image-upload name="image" label="الصورة" :value="$category->image" />
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="content_type" id="content_type" class="form-control @error('content_type') is-invalid @enderror">
                                        ...
                                        @foreach(\App\Models\Category::CONTENT_TYPES as $value => $label)
                                            <option value="{{ $value }}" {{ old('content_type', $category->content_type) === $value ? 'selected' : '' }}>{{ $label }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="icon" id="icon" class="form-control @error('icon') is-invalid @enderror" value="{{ old('icon', $category->icon) }}" placeholder="fe fe-folder">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="mt-2">
                                        <label class="custom-control custom-checkbox">
                                            <input type="checkbox" name="is_active" value="1" class="custom-control-input" {{ old('is_active', $category->is_active) ? 'checked' : '' }}>
                                            <span class="custom-control-label">نشط</span>
                                        </label>
                                        <label class="custom-control custom-checkbox">
                                            <input type="checkbox" name="is_featured" value="1" class="custom-control-input" {{ old('is_featured', $category->is_featured) ? 'checked' : '' }}>
