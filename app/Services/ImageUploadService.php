...
class ImageUploadService
{
     ...
     * @return string|null
     */
    public function handle($fileOrUrl, string $folder = 'images', ?string $oldPath = null): ?string
    {
        ...
        if ($fileOrUrl instanceof UploadedFile) {
            // التحقق من نوع الملف
            if (!$fileOrUrl->isValid() || !str_starts_with($fileOrUrl->getMimeType(), 'image/')) {
